...
package 
{
  ...
  import CrossBridge.quake1.*;
  import CrossBridge.quake1.vfs.*;
  ...
  */
  ...
  public class Console extends Sprite implements ISpecialFile
  {
    ...
    private static var pakClass : Class;
    ...
    */
    protected function init(e:Event):void
    {
      ...
      try
      {
		...
		//simplified method for suppplying C/C++ the files needed,
		//see [http://bruce-lab.blogspot.com/2013/11/migrating-from-alchemy-to.html] for details.
		CModule.vfs.addFile("id1/pak0.pak", new pakClass());
